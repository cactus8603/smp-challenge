...
- has_user_description already existed in v2; kept unchanged.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build unified SMP dataset tables, v3: timezone imputation + sentiment.")
